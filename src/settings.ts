...
*/
export const SITE_URL = "https://myaccount.bestproxy.net/";

/*
 Your site name - this appears in the footer
*/
export const SITE_NAME = "BESTPROXY";
...
*/
export const TOS_LAST_UPDATE = 'Sep-26-2019';

/*
 This is the link of your chat widget - it can be found on your tawk to account
*/
export const TAWK_TO_WIDGET_URL = 'https://embed.tawk.to/5d8cba68db28311764d5ff03/default';
